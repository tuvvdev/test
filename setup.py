...
setup(
  name = 'test_tuvovan',         # How you named your package folder (MyLib)
  packages = ['test_tuvovan'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/tuvvdev/test/archive/refs/tags/0.2.tar.gz',    # I explain this later on
